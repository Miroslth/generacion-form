...
function formatImportNames(importNames) {
  return new Intl.ListFormat('en-US').format(importNames.map((name) => `'${name}'`));
}
          ...
          if (importName === '*') {
            ...
            if (restrictedImportNames) {
              context.report({
                ...
                data: {
                  importSource,
                  importNames: formatImportNames(restrictedImportNames),
              ...
              context.report({
                ...
                data: {
                  importSource,
                  allowedImportNames: formatImportNames(allowedImportNames),
